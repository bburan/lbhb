...
model {
    ...
    b = exp(bt_loc + bt_cond_delta[i_cond] * bt_cond_scale + bt_sess_delta[i_sess] * bt_sess_scale);
    gt = gt_loc + gt_cond_delta[i_cond] * gt_cond_scale + gt_sess_delta[i_sess] * gt_sess_scale;
    g = inv_logit(gt);
